                                    ...
                                    $MyValues = $MyConnection -> query($MySearchQuery);
                                        ...
                                        if (($MyValues -> num_rows) > 0)
                                        {
                                            while ($MyResults = $MyValues -> fetch_assoc())
                                            {
                                                ...
                                                echo '<td><a rel="facebox" href="history.php?lname='.$MyResults['STUD_LASTNAME'].'&fname='.$MyResults['STUD_FIRSTNAME'].'">'.$MyResults['STUD_LASTNAME'].'</a></td>';
                                                ...
                                                echo '<td>'.$MyResults['DATE_STARTED'].'</td>';
                                                echo '<td><a rel="facebox" href="payment_student.php?lastname='.$MyResults['STUD_LASTNAME'].'&firstname='.$MyResults['STUD_FIRSTNAME'].' &date_add='.$Myresults['DATE_ADDED'].'">pay</a></td>';
                                                echo '<td><a rel="facebox" href="edit_student.php?name='.$Myresults->STUD_NAME.'">Edit</a></td>';
                                                

                                                echo '<td><a rel="facebox" href="delete_student.php?lastname='.$MyResults['STUD_LASTNAME'].'&firstname='.$MyResults['STUD_FIRSTNAME'].'" onClick="return deleteconfig()">Archive</a></td></tr>';
