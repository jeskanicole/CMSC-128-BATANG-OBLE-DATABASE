            ...
            <form class="form" action="query.php">
                ...
                <div class="col-2 col-form-label">
                    <select name = "search_Filter" id = "sell" class = "form-control" onchange = "updateFields(this.value)">
                        ...
                        <option value = "1">Student Assistant Name</option>
                        <option value = "2">SA Student Number</option>
                        <option value = "3">Application Year</option>
                        <option value = "4">Sex (Student)</option>
                        <option value = "5">Sex (Student Assistant)</option>
                    </select>
                </div>
            </br>
                <!-- Search Bar -->
