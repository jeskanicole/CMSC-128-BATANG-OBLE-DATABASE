		...
		<?php
			$SearchFilter = $_REQUEST['search_Filter'];
 			...
 			{	
 				...
 				{
 					$MySearchQuery = "SELECT * FROM SA WHERE SA.SA_LASTNAME LIKE '%$MySearchRequest%' or SA.SA_FIRSTNAME LIKE '%$MySearchRequest%';";
 				...
 				else if($SearchFilter == 5 && $MySearchRequest != "")
 				{
 					$MySearchQuery = "SELECT * FROM SA WHERE SA.SA_SEX LIKE '%$MySearchRequest%';";
