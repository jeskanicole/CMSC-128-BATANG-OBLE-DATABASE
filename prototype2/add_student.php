<?php
	...
	if($_POST['save'])
	{
		...
		mysqli_query($MyConnection, "INSERT INTO STUDENT (STUD_LASTNAME, STUD_FIRSTNAME, STUD_SEX, STUD_BIRTHDAY, STUD_AGE, PAR_LASTNAME, PAR_FIRSTNAME, PARENT_CONTACT, PAYMENT_TYPE, DATE_APPLICATION) VALUES ('$nslastname', '$nsfirstname', '$nsex', '$nbirthday', '$nage', '$nplastname', '$npfirstname', '$ncontact', '$nemail', '$nsnum', '$ntype', '$nacadyr', '$nsem', $namt_borrowed, $namt_borrowed,'$fixedReason', '$ndate');");
