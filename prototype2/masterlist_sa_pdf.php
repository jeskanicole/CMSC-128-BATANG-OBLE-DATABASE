...
$d=date('d_m_Y');
	...
	$header=array('Student Number', 'Last Name', 'First Name', 'Course', 'College', 'Year', 'Sex', 'Address', 'Email Address', 'Contact Number');
	//Data loading
	//*** Load MySQL Data ***//
	$dbhost = 'localhost';
	$dbuser = 'root';
	...
	$query = mysqli_query($conn, "SELECT SA_STUDNUM, SA_LASTNAME, SA_FIRSTNAME, SA_COURSE, SA_COLLEGE, SA_YEAR, SA_SEX, SA_ADDRESS, SA_EMAIL, SA_CONTACT FROM SA");
	$resultData = array();
	...
	$w=array(30,35,35,35,14,13,13,40,35,25);
	...
	{
		$pdf->CellFitScale(30,8,$eachResult['SA_STUDNUM'],1,0,'C',1);
		$pdf->CellFitScale(35,8,$eachResult['SA_LASTNAME'],1, 0,'C',1);
		$pdf->CellFitScale(35,8,$eachResult['SA_FIRSTNAME'],1,0,'C',1);
		$pdf->CellFitScale(35,8,$eachResult['SA_COURSE'],1,0,'C',1);
