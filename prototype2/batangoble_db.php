<?php
	...
	$query = "INSERT INTO STUDENT VALUES
		('Aquino', 'Amalia Rita Marie', 'F', '2016-06-22', 1, 'Rulla', 'Thalia Ingrid', '09067228227', 'Student', 'Monthly'),
		('Claros', 'Light Alexandre', 'M', '2016-09-2016', 1, 'Manio', 'Johannah Marah', '09067156445', 'Student', 'Drop in'),
		('Custodio', 'Calvin Lee', 'M', '2013-08-25', 4, 'Custodio', 'Judylyn', '09178795266', 'Alumni', 'Drop in'),
		('Dacay', 'Gibson Dwayne', 'M', '2014-05-07', 2, 'Dacay', 'Wyndie', '09483598772', 'Admin/REPS', 'Drop in'),
		('Florendo', 'John Immanuel', 'M', '2016-09-08', 1, 'Florendo', 'Ma. Rosario', '09985426982', 'Faculty', 'Monthly'),
		('Gabatin', 'Jessica', 'F', '2014-04-08', 3, 'Gabatin', 'Marilou', '09460458446', 'Agency', 'Monthly'),
		('Himmiwat', 'Corinth', 'F', '2014-08-08', 3, 'Himmiwat', 'Anselmo', '09155387700', 'Admin/REPS', 'Drop in'),
		('Jularbal', 'Maximillian', 'M', '2015-09-02', 1, 'Jularbal', 'Io', '09163213466', 'Faculty', 'Monthly')
		";
	mysqli_query($conn, $query);
